...
\(fn &optional SEARCH NIX-FILE)" t nil)
...
;;;***

;;;### (autoloads nil "nix-shell-haskell" "nix-shell-haskell.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from nix-shell-haskell.el

(autoload 'nix-shell-haskell "nix-shell-haskell" "\
Setup Nix shell from the .cabal file.

\(fn &optional CABAL-FILE)" t nil)

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "nix-shell-haskell" '("nix-shell-haskell--callback")))
