...

;;;### (autoloads nil "opencc" "opencc.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "opencc" '("multi-isearch-search-fun@support-opencc" "opencc-")))
